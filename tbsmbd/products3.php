		...
		<div class="container">
				...
				<div class="products-row">
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/h3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Queen Size Bed</a></h5>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/h1.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Wall Clock</a></h5>
								<h6><del>$82</del> $80</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href="single.php"><img src="images/h2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Plants & Vases</a></h5>
								<h6><del>$41</del> $40</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/h5.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Snow Blower</a></h5>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>14%<br>Off</h6></div>
							<a href="single.php"><img src="images/h4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Flower pot</a></h5>
								<h6><del>$35</del> $30</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" />
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.php">Garage Storage</a></li>
						<li><a href="products.php">Casseroles</a></li>
						<li><a href="products.php">Living Room</a></li>
						<li><a href="products.php">Mattresses</a></li>
						<li><a href="products.php">Patio Tips</a></li>
						<li><a href="products.php">Patio Tips</a></li>
						<li><a href="products.php">Gardening</a></li>
						<li><a href="products.php">Furniture</a></li>
						<li><a href="products.php">Wall Decor</a></li>
						<li><a href="products.php">Floor Cleaning</a></li>
					</ul>
				</div>
				<div class="related-row">
