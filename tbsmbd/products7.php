...
<html lang="en">
<head>
<title>Smart Bazaar an E-commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Products7 :: w3layouts</title>
				...
				<div class="products-row">
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/b1.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Facial Cleanser</a></h5>
								<h6><del>$10</del> $9</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/b2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Shaver</a></h5>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/b3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Gel Cream</a></h5>
								<h6><del>$10</del> $6</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/b4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Lakme Combo</a></h5>
								<h6><del>$12</del> $10</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/f9.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Baby Care</a></h5>
