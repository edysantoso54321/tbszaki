...
<body>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body modal-body-sub">
	        ...
	        <select class="form-control bfh-states" data-country="US" data-state="CA">
	          ...
	          <option value="B">Kota Bandung</option><option value="BK">Kab. Bandung</option>
	        </select>
	        <input type="text" name="Name" placeholder="Enter your area / Kecamatan / Zipcode" required="">
			...
			<div class="footer-info w3-agileits-info">
				<div class="col-md-4 address-left agileinfo">
					<div class="footer-logo header-logo">
						<h2><a href="index.php"><span>Red</span>Market <i></i></a></h2>
						<h6>Your stores. Your place.</h6>
					</div>
					<ul>
						<li><i class="fa fa-map-marker"></i> Bandung, Jawa Barat Indonesia.</li>
						<li><i class="fa fa-mobile"></i> 082116399291 </li>
						<li><i class="fa fa-phone"></i> 021325649 </li>
	...
	<div class="copy-right">
		<div class="container">
			<p>© 2018 RED Market . All rights reserved | Design by Kelompok 4.</a></p>
		</div>
	</div>
	<!-- cart-js -->
