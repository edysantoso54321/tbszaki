...
<body>
	...
	<div class="about">
		<div class="container">
			<h3 class="w3ls-title w3ls-title1">About RED Market</h3>
			<div class="about-text">
				<p>A forum for buying and selling or promotional media for his special students at Telkom University. Anyone can open an online store to then serve prospective buyers from all over Indonesia either unit or in large quantities.
					Individual or corporate users can buy and sell products, both new and used, such as bicycles, mobile phones, baby gear, gadgets, accessory devices, computers, slate (tablet), home appliances, clothing, electronics, and more.</p>
			...
			<div class="history">
				...
				<p>Empower Students who want to invest in terms of buying and selling, as well as an economic foothold among university telkom students.</p>
				<h3 class="w3ls-title">Our History</h3>
				<p>We started the year 2018 when it was working on the project course Digital Business Model finally came up to create a forum web-based buying and selling.</p>
			</div>
		</div>
	</div>
	<!-- //about-page -->
