		...
		<div class="container">
				...
				<div class="products-row">
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/a5.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Tyre</a></h5>
								<h6><del>$45</del> $40</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/a6.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Helmet </a></h5>
								<h6><del>$20</del> $17</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/a2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Car Battery</a></h5>
								<h6><del>$26</del> $25</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>OFF</h6></div>
							<a href="single.php"><img src="images/a3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Seating Pad</a></h5>
								<h6><del>$32</del> $30</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>OFF</h6></div>
							<a href="single.php"><img src="images/a4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Coolant </a></h5>
								<h6><del>$15</del> $13</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.php">Wheel Covers</a></li>
						<li><a href="products.php">Cargo Management</a></li>
						<li><a href="products.php">Polish & Waxes</a></li>
						<li><a href="products.php">GPS Navigation</a></li>
						<li><a href="products.php">Cleaning Tools</a></li>
						<li><a href="products.php">Detailing Kits</a></li>
						<li><a href="products.php">Car Washes</a></li>
						<li><a href="products.php">Auto Repair Tools</a></li>
						<li><a href="products.php">Helmets</a></li>
						<li><a href="products.php">Sensors</a></li>
					</ul>
				</div>
				<div class="related-row">
