...
<html lang="en">
<head>
<title>Smart Bazaar an E-commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Products6 :: w3layouts</title>
		...
		<div class="container">
				...
				<div class="products-row">
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/p1.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Coffee Mug</a></h5>
								<h6><del>$16</del> $14</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/p2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Teddy bear</a></h5>
								<h6><del>$25</del> $20</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/p3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Chocolates</a></h5>
								<h6><del>$80</del> $60</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/p4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Gift Card</a></h5>
								<h6><del>$25</del> $22</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>Sale</h6></div>
							<a href="single.php"><img src="images/g5.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Dry Fruits</a></h5>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href="single.php"><img src="images/g2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Gourmet Food</a></h5>
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.php">Shelf Animation</a></li>
						<li><a href="products.php">Flowers</a></li>
						<li><a href="products.php">Dry Fruits</a></li>
						<li><a href="products.php">Mounted Photos</a></li>
						<li><a href="products.php">Decorative Plants</a></li>
						<li><a href="products.php">Best Priced</a></li>
						<li><a href="products.php">Sweets</a></li>
						<li><a href="products.php">Chocolates</a></li>
						<li><a href="products.php">3D-Rendered</a></li>
						<li><a href="products.php">Cards & Toys</a></li>
					</ul>
				</div>
				<div class="related-row">
