		...
		<div class="container">
				...
				<div class="products-row">
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/f6.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Lunch Box</a></h5>
								<h6><del>$20</del> $16</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.php">Video Games</a></li>
						<li><a href="products.php">Casual Wear</a></li>
						<li><a href="products.php">Preschool Toys</a></li>
						<li><a href="products.php">T-Shirts</a></li>
						<li><a href="products.php">Blazers</a></li>
						<li><a href="products.php">Winter Wear</a></li>
						<li><a href="products.php">Shoes</a></li>
						<li><a href="products.php">Baby Care</a></li>
