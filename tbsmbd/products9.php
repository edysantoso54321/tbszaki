...
<html lang="en">
<head>
<title>Smart Bazaar an E-commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Products9 :: w3layouts</title>
		...
		<div class="container">
				...
				<div class="products-row">
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/m1.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Teens Book</a></h5>
								<h6><del>$10</del> $9</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/m2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Music CD</a></h5>
								<h6><del>$5</del> $4</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/m3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Movie DVD</a></h5>
								<h6><del>$8</del>$6</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/m4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Story Book</a></h5>
								<h6><del>$10</del> $8</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.php">Civil Services</a></li>
						<li><a href="products.php">Academic Text</a></li>
						<li><a href="products.php">Music DVDs</a></li>
						<li><a href="products.php">Hollywood Movies</a></li>
						<li><a href="products.php">New Releases</a></li>
						<li><a href="products.php">Best Programs</a></li>
						<li><a href="products.php">Album Songs</a></li>
						<li><a href="products.php">Pop</a></li>
						<li><a href="products.php">Country Music</a></li>
