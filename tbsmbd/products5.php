...
<html lang="en">
<head>
<title>Smart Bazaar an E-commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Products5 :: w3layouts</title>
				...
				<div class="products-row">
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/g1.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Coca Cola</a></h5>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/g3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Snacks</a></h5>
								<h6><del>$50</del> $40</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/g4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Raisin Bran</a></h5>
								<h6><del>$42</del> $40</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>Sale</h6></div>
							<a href="single.php"><img src="images/g6.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Nescafe Coffee</a></h5>
								<h6><del>$12</del> $10</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						...
						<li><a href="products.php">Snacks & Cookies</a></li>
						<li><a href="products.php">Candy & Gum</a></li>
						<li><a href="products.php">Meals & Pasta</a></li>
						<li><a href="products.php">Pet Food</a></li>
						<li><a href="products.php">Household Essentials</a></li>
						<li><a href="products.php">Pest Control</a></li>
						<li><a href="products.php">Nutrition</a></li>
						<li><a href="products.php">Paper & Plastic</a></li>
					</ul>
				</div>
				<div class="related-row">
