...
<html lang="en">
<head>
<title>Smart Bazaar an E-commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Products4 :: w3layouts</title>
				...
				<div class="products-row">
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/s1.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Roller Skates</a></h5>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/s3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Nylon Shuttle</a></h5>
								<h6><del>$60</del> $56</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/s2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Football</a></h5>
								<h6><del>$71</del>$70</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/s5.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Exercise Bike</a></h5>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>OFF</h6></div>
							<a href="single.php"><img src="images/s4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">
								<h5><a href="single.php">Cricket Kit</a></h5>
								<h6><del>$82</del> $80</h6>
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/>
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						...
						<li><a href="products.php">Health Drinks</a></li>
						<li><a href="products.php">Lights & Lanterns</a></li>
						<li><a href="products.php">Body Massagers</a></li>
						<li><a href="products.php">Musical Instruments</a></li>
						<li><a href="products.php">Health Monitors</a></li>
						<li><a href="products.php">Shoes</a></li>
						<li><a href="products.php">Sports Apparel</a></li>
						<li><a href="products.php">Badminton</a></li>
						<li><a href="products.php">Shooting</a></li>
					</ul>
				</div>
				<div class="related-row">
